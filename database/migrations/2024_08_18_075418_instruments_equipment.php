...
class InstrumentsEquipment extends Migration
{
    public function up()
    {
        Schema::create('instruments_equipment', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('description_ua', 3000);
            ...
            $table->double('mass_without_package')->nullable();
            $table->double('mass_in_package')->nullable();
    ...
    {
        Schema::dropIfExists('instruments_equipment');
    }
}