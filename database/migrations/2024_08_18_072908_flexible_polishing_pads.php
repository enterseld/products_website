...
class FlexiblePolishingPads extends Migration
{
    public function up()
    {
        Schema::create('flexible_polishing_pads', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('flexible_polishing_pads');
    }
}