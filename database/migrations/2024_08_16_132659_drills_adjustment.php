...
class DrillsAdjustment extends Migration
{
    public function up()
    {
        Schema::create('drills_adjustment', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('height_without_package', 50);
            $table->double('height_in_package');
    ...
    {
        Schema::dropIfExists('drills_adjustment');
    }
}